...
export default function SignUp() {
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-orange-500 to-orange-700 font-albra flex flex-col justify-center items-center">
      <div>
        <Link
          to="/"
        ...
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            ...
            dispatch(
              ...
              .then((res) => {
                if (isRejected(res) || isRejectedWithValue(res)) {
                  showErrorToast("An error has occurred");
                } else {
                  setShowToast(false);
                  showSuccesToast('Account created successfully.')
                  resetForm();
                  navigate("/");
                }
              })
